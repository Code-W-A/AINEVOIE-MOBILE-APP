...
const COUNTY_DEFINITIONS = Object.freeze([
  ...
  { countyCode: 'IS', countyName: 'Iasi', aliases: ['Iași'], cities: ['Iasi', 'Pascani', 'Harlau', 'Targu Frumos', 'Podu Iloaiei'] },
  { countyCode: 'IF', countyName: 'Ilfov', cities: ['Voluntari', 'Buftea', 'Pantelimon', 'Otopeni', 'Popesti-Leordeni', 'Magurele'] },
  { countyCode: 'MM', countyName: 'Maramures', aliases: ['Maramureș'], cities: ['Baia Mare', 'Sighetu Marmatiei', 'Borsa', 'Viseu de Sus', 'Targu Lapus'] },
  { countyCode: 'MH', countyName: 'Mehedinti', aliases: ['Mehedinți'], cities: ['Drobeta-Turnu Severin', 'Orsova', 'Strehaia', 'Vanzu Mare'] },
  { countyCode: 'MS', countyName: 'Mures', aliases: ['Mureș'], cities: ['Targu Mures', 'Sighisoara', 'Reghin', 'Tarnaveni', 'Ludus'] },
  { countyCode: 'NT', countyName: 'Neamt', aliases: ['Neamț'], cities: ['Piatra Neamt', 'Roman', 'Targu Neamt', 'Bicaz', 'Roznov'] },
  ...
  { countyCode: 'SJ', countyName: 'Salaj', aliases: ['Sălaj'], cities: ['Zalau', 'Simleu Silvaniei', 'Jibou', 'Cehu Silvaniei'] },
  ...
  { countyCode: 'TM', countyName: 'Timis', aliases: ['Timiș'], cities: ['Timisoara', 'Lugoj', 'Sannicolau Mare', 'Jimbolia', 'Deta'] },
  ...
  { countyCode: 'VL', countyName: 'Valcea', aliases: ['Vâlcea'], cities: ['Ramnicu Valcea', 'Dragasani', 'Calimanesti', 'Babeni', 'Horezu'] },
  { countyCode: 'VN', countyName: 'Vrancea', cities: ['Focsani', 'Adjud', 'Marasesti', 'Odobesti', 'Panciu'] },
  { countyCode: 'B', countyName: 'Bucuresti', aliases: ['București', 'Municipiul Bucuresti', 'Municipiul București'], cities: ['Sector 1', 'Sector 2', 'Sector 3', 'Sector 4', 'Sector 5', 'Sector 6'] },
]);
...
const ROMANIA_COUNTIES = Object.freeze(
...
function resolveRomaniaCoverageHierarchy(input = {}) {
  ...
  const isRomania = countryValue.length === 0
    || countryValue.some((value) => ['ro', 'romania', 'românia'].includes(normalizeToken(value)));
